...
public class RefreshTokenService {
	...
	private RefreshTokenRepo refreshTokenRepo;
	 ...
	 public RefreshTokenService(UserRepo userRepo) {
		this.userRepo = userRepo;
		
	}

	@Autowired
	public void setRefreshTokenRepo(RefreshTokenRepo refreshTokenRepo) {
	...
	public ResponseCookie generateRefreshToken(Authentication authentication,HttpServletRequest request) {
		...
		ResponseCookie refreshCookie =
			    ResponseCookie.from("refreshToken", savedToken.getToken())
			        .httpOnly(true)
			        .secure(false)
