...
public class IncomSourceController {
	...
	@PatchMapping("/edit/{currentSource}/{newSource}")
	public ResponseEntity<?> editCustomIncomeSource(@PathVariable String currentSource,@PathVariable String newSource) {

		incomeSourceService.editCustomIncomeSource(currentSource, newSource);
